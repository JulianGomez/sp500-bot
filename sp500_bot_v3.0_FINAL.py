...
# ════════════════════════════════════════════════════════════════════════════
# DATA MANAGER (Corregido para evitar errores de NoneType)
# ════════════════════════════════════════════════════════════════════════════
class DataManager:
...
class S500Bot:
    def __init__(self):
        ...
        self.position = None # {symbol, entry_price, qty}

    def is_market_open(self):
        # Usamos pytz para manejar la zona horaria de Nueva York correctamente
        tz_ny = pytz.timezone('America/New_York')
        now_ny = datetime.now(tz_ny)
        # Lunes a Viernes, de 9:30 a 16:00
    ...
    def run(self):
        log.info("🚀 BOT S&P 500 INICIADO - Modo Live")
        self.tg.send("🤖 *Bot S&P 500 Activo*\nMonitoreando RSI(10) en 7 acciones.")
